...
| 🔊 **أصوات الأذان والإقامة** | تشغيل ملف صوتي عشوائي عند الأذان (مع فصل صوت الفجر) وعند الإقامة |
...
3. اذهب إلى **Settings → Pages → Source** واختر **Deploy from a branch** ← `main`
4. ستصبح اللوحة متاحة على: `https://اسم-المستخدم.github.io/free-masjid-dashboard/`

### الطريقة 3: أي استضافة ثابتة

انسخ جميع الملفات إلى أي خادم ويب (Nginx، Apache، Netlify، Vercel...) — لا حاجة لأي بيئة خلفية.
...
> - الملفات غير الموجودة تُتجاهل تلقائياً — لا أخطاء
...
هذا المشروع مفتوح المصدر ومتاح للاستخدام الحر لجميع المساجد والمؤسسات الإسلامية.
