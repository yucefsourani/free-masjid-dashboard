...
| 🔊 **أصوات الأذان والإقامة** | تشغيل ملف صوتي عشوائي عند الأذان (مع فصل صوت الفجر) وعند الإقامة — مع آلية تفعيل ذكية |
...
| 🔇 **تفعيل الصوت التلقائي** | شريط ذكي يطلب تفعيل الصوت مرة واحدة فقط، ويحفظ الموافقة دائماً |
...
**آلية تفعيل الصوت:**
- عند أول زيارة → يظهر شريط "اضغط هنا لتفعيل صوت الأذان" في أسفل الصفحة
- بعد الضغط → يتم حفظ الموافقة في المتصفح نهائياً
- في الزيارات التالية → يتم تفعيل الصوت تلقائياً بدون شريط
...
> **ملاحظة:** خيار `--autoplay-policy=no-user-gesture-required` يسمح بتشغيل الصوت بدون أي ضغطة — مثالي للشاشات بدون أجهزة إدخال.
